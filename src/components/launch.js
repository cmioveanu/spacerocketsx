...
export default function Launch({ state, dispatch }) {
  ...
  return (
    <div>
      ...
      />
      <Header launch={launch} state={state} dispatch={dispatch} />
      <Box m={[3, 6]}>
...
function Header({ launch, state, dispatch }) {
  return (
    <Flex
    ...
    <SimpleGrid columns={[1, 1, 2]} borderWidth="1px" p="4" borderRadius="md">
      <Stat>
        ...
        <StatNumber fontSize={["md", "xl"]}>
          <Tooltip bgColor="gray.800" label={formatDateTime(launch.date_local)} borderRadius="md" padding="3">
